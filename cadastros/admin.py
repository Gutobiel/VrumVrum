...
# from django.contrib.auth.admin import UserAdmin as BaseUserAdmin
# from django.utils.translation import gettext_lazy as _
# from .models import CustomUser, Cargo, Orgao, TipoAcesso
# from .forms import CustomUserChangeForm, CustomUserCreationForm
...
#         (_('Permissions'), {'fields': ('is_active', 'is_staff', 'is_superuser', 'groups', 'user_permissions')}),
#         (_('Important dates'), {'fields': ('last_login',)}),
#         (_('Additional info'), {'fields': ('cargo', 'orgao', 'setor', 'status', 'tipo_acesso', 'observacoes')}),
#     )
#     add_fieldsets = (
#         (None, {
#             'classes': ('wide',),
#             'fields': ('username', 'email', 'password1', 'password2', 'celular', 'cargo', 'orgao', 'setor', 'status', 'tipo_acesso', 'observacoes'),
#         }),
#     )
#     list_display = ('username', 'email', 'is_staff', 'is_active', 'cargo', 'orgao')
#     search_fields = ('username', 'email')
